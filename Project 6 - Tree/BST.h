...
class BST
{
 ...
 ------------------------------------------------------------------------*/
 int findHeight(BinNode * node) const;
 int findLeafCount(BinNode * node) const;
...
//--- Definition of findLeafCount()
template <typename DataType>
int BST<DataType>::findLeafCount(BinNode * node) const{
    if(node == NULL){
        return 0;
    }
    return 1 + findLeafCount(node->left) + findLeafCount(node->right);
}
//--- Definition of getLeafCount()

template <typename DataType>
int BST<DataType>::getLeafCount() const{
    return findLeafCount(myRoot);
}
//--- Definition of findHeight()
template <typename DataType>
int BST<DataType>::findHeight(BinNode * node) const{
    if(node == NULL){
        return 0;
    }
...
template <typename DataType>
int BST<DataType>::getHeight() const{
